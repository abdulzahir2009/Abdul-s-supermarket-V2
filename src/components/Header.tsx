...
type Page = "home" | "products" | "product-detail" | "cart" | "checkout" | "search" | "deals" | "about" | "whatsapp-confirm";
        ...
        <div className="md:hidden border-t border-gray-100 bg-white px-4 py-2">
          {navLinks.map((link) => (
            <button
              ...
              style={{ fontFamily: "Montserrat, sans-serif", color: currentPage === link.page ? "#005691" : "#333", fontWeight: currentPage === link.page ? 700 : 500 }}
            >
              {link.label}
            </button>
          ))}
